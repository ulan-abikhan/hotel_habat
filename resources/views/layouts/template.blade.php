        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="navbar-brand logo_h" href="{{ route('landing') }}"><h5>Отель Элеон</h5></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('landing') }}">Главная</a></li>
                            <li class="nav-item"><a class="nav-link" href="#facilities">Удобства</a></li>
                            <li class="nav-item"><a class="nav-link" href="#about">О нас</a></li>
                            @guest
                                <li class="nav-item"><a class="nav-link" href="{{ route('login') }}"><i class="fas fa-sign-out-alt"></i> Войти/Регистрация</a></li>
                            @else
                ...
                <div class="row">
                    <div class="col-lg-4  col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <p>Мир стал настолько быстрым, что люди не хотят стоять и читать страницу информации, они скорее посмотрят на презентацию и поймут сообщение. Это дошло до точки. </p>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            <h6 class="footer_title">Информационный бюллетень</h6>
                            <p>Для профессионалов в бизнесе, оказавшихся между высокой ценой OEM и посредственным качеством печати и графики </p>
